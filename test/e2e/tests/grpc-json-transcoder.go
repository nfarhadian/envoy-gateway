...
var GRPCJSONTranscoderTest = suite.ConformanceTest{
	...
	Test: func(t *testing.T, suite *suite.ConformanceTestSuite) {
		...
		// The transcoder rewrites :path to the gRPC method and Envoy matches routes again,
		// so the rewritten path needs a route of its own. Both ways of providing one are
		// exercised here.
